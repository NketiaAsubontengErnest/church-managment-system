			...
			<div class="contact-details col-md-6 " >
				...
				<ul class="contact-short-info" >
					<li>
						...
						<span>University of Education, Winneba (I.C.T Education)</span>
					</li>
					<li>
						<i class="tf-ion-android-phone-portrait"></i>
						<span>Phone: +233-55-401-3980</span>
					</li>
					<li>
						<i class="tf-ion-android-globe"></i>
						<span>Fax: +233-24-056-1313</span>
					</li>
					<li>
						<i class="tf-ion-android-mail"></i>
						<span>Email: nketiaernest108@gmail.com</span>
					</li>
				</ul>
				<!-- Footer Social Links -->
